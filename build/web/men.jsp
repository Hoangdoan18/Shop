<%-- 
    Document   : men
    Created on : Jul 12, 2021, 10:52:44 PM
    Author     : USER
--%>
    ...
    <div class="product">
        ...
        <div class="product-container">        
            <div class="row">
                ...
                <c:forEach items="${mo}" var="p">
                    <div class="col-4">
                        <img src=".\img\products\redtshirt.jpg">
                        <h4>mo.name</h4>
                        <p>mo.price</p>
                        <c:url value="/addtocart?id=${mo.ProducID}" var="addtocart"/>
        ...
        <div class="product-container">        
            <div class="row">
               <c:forEach items="${mt}" var="p">
                    <div class="col-4">
                        <img src=".\img\products\redtshirt.jpg">
                        <h4>mt.name</h4>
                        <p>mt.price</p>
                        <c:url value="/addtocart?id=${mt.ProducID}" var="addtocart"/>
                        <a href="${addtocart}">Add to cart</a>
                    </div>
                </c:forEach>
            </div>
